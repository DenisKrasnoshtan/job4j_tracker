...
public class SchoolTest {
    ...
    public void whenCollectClassB() {
        ...
        School school = new School();
        Predicate<Student> predicateOne = student -> student.getScore() >= 50;
        Predicate<Student> predicateTwo = student -> student.getScore() < 70;
        List<Student> result = school.collect(students, predicateOne.and(predicateTwo));
        List<Student> expected = new ArrayList<>();
